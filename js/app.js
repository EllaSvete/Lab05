...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  return [ sumTwo, productTwo, `${a} and ${b} and ${c} sum to ${sumTwo}.` , `The product of ${a} and ${b} and ${c} is ${productTwo}.`]
}
...
function sumArray(sumArr) { //eslint-disable-line
  ...
  let finalSum = sum(arraySum, sumArr[2])[0];
...
let arrayProduct = [2, 3, 4];
function multiplyArray(multArr) { //eslint-disable-line
  let arrayProduct = multiply(multArr[0] , multArr[1])[0];
  let finalProduct = multiply(arrayProduct, multArr[2])[0];
